                ...
                <tbody>
                    ...
                    @foreach ($data as $table)
                        <tr>
                            ...
                            <td>{{ $table->name }}</td>
                            <td>
                                <span class="badge bg-secondary">{{ $table->members_count }}</span>
                            </td>
                            <td>
                                <a href=""><i class="fa fa-edit text-warning"></i></a>

                                @if ($table->members_count == 0)
                                    <a href="#" class="ml-2" wire:click.prevent='delete'><i
                                            class="fa fa-trash text-danger"></i></a>
                                @else
                                    <a href="#" class="ml-2" wire:click.prevent='rename'><i
